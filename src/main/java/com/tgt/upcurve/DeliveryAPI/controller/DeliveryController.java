...
public class DeliveryController {
    ...
    public DeliveryEntity fetchDeliveryByCustomerIdAndOrderId(@Validated @PathVariable("customer_id")
                                                                          Integer customerId,
    ...
    public List<DeliveryEntity> fetchDeliveryByCustomerId(@Validated @PathVariable("customer_id")
                                                                      Integer customerId) {
        return deliveryService.fetchDeliveryByCustomerId(customerId);
    }

    @GetMapping("/fetch_delivery_details_by_date/{pickup_date}")
    public List<DeliveryEntity> getDeliveryDetailsByDate(@PathVariable("pickup_date")
